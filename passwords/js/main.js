   ...
   button.addEventListener('click', ()=> {
    ...
    newForm.addEventListener('submit', (e)=>{
      e.preventDefault();
        ...
        getEdit(passwords,currentSite.site, newSite.value, newUserName.value, newEmail.value, newPassword.value);
...
function getEdit(old,newnow, eachInput1, eachInput2, eachInput3, eachInput4){
